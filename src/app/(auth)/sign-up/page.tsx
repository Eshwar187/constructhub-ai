      ...
      >
        <div className="mb-10 text-center">
          ...
          <h1 className="text-4xl font-extrabold mb-4">
            <span className="text-yellow-400 dark:text-yellow-400">Join</span>
          ...
          <p className="text-gray-300 dark:text-gray-300 max-w-md mx-auto text-lg">
            Create your account to start managing construction projects with AI-powered insights
          </p>
        </div>
            ...
            <CardContent>
              {process.env.NEXT_PUBLIC_USE_MOCK_AUTH === 'true' ? (
                ...
                <ClerkSignUp
                  appearance={{
                    elements: {
                      formButtonPrimary: 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold shadow-lg shadow-blue-700/20 transition-all duration-300 hover:shadow-blue-700/40',
                      ...
                      profileSectionPrimaryButton: 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white',
